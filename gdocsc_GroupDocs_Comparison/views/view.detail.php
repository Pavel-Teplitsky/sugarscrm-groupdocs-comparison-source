	 ...
	 *
 	...
 	public function display()
 	{
		...
		while (($row = $GLOBALS['db']->fetchByAssoc($result)) != null) {
			print '<iframe id="groupdocs_comparison_iframe" height="950" frameborder="0" width="800" src="https://apps.groupdocs.com/document-comparison/embed/'.$row['embed_key'].'/'.$row['file_id'].'?&referer=' . $cmsName . '/' . $cmsVersion . '"></iframe>';
			print '<br>';
		}
