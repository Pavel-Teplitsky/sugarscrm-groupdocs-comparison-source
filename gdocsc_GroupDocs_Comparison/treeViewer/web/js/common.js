...
//				container.removeClass("fileTree-loading");
		...
		if(this.options.isFolder){
			AJS.$("div[name='groupdocsBrowserInner']", this.element).fileTree(opts, undefined, onFileSelected);
		} else {
			AJS.$("div[name='groupdocsBrowserInner']", this.element).fileTree(opts, onFileSelected);
		}
	}
