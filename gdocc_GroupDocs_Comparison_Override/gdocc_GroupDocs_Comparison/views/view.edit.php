...
class gdocc_GroupDocs_ComparisonViewEdit extends ViewEdit{
 	function gdocc_GroupDocs_ComparisonViewEdit(){
 		parent::ViewEdit();
 	}
 	function display(){
...
//			$privateKey = $this->bean->api_key;
			$userId = $this->bean->client_id;

//			if($privateKey && $userId){
//				$signer = new GroupDocsRequestSigner($privateKey);
//                $apiClient = new APIClient($signer);
//                $api = new StorageApi($apiClient);
//                $result = $api->ListEntities($userId, '', 0);
//				
