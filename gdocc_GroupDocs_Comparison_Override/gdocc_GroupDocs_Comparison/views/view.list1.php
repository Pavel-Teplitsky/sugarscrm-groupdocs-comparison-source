...
class gdocc_GroupDocs_ComparisonViewList extends ViewHtml
{
 	...
 	public function preDisplay()
 	{
		...
		$query = "SELECT g.id, g.assigned_user_id, g.created_by, g.client_id, g.file_id, t.item_summary AS uname
					FROM gdocc_groupdocs AS g
		...
		while (($row = $GLOBALS['db']->fetchByAssoc($result)) != null) {
			print '<span style="color:red;font:12pt Arial;font-weight:bold;">Edit:</spam> <a href="index.php?module=gdocc_GroupDocs_Comparison&amp;offset=1&amp;return_module=gdocc_GroupDocs_Comparison&amp;action=EditView&amp;record='.$row['id'].'" id="edit-'.$row['id'].'" title="Edit">
            ...
            $cmsName = "SugarCRM";
            $cmsVersion = "1.0";
			print '<iframe id="groupdocs_iframe" height="300" frameborder="1" width="500" src="https://apps.groupdocs.com/document-comparison/embed/'.$row['client_id'].'/'.$row['file_id'].'?&referer=' . $cmsName . '/' . $cmsVersion . '"></iframe>';
			print '<br><br>';
