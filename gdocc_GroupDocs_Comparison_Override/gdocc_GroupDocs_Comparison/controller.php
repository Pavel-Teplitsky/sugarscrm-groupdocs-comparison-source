 ...
 */
 ...
 class gdocc_GroupDocs_ComparisonController extends SugarController
{
...
//		include_once('treeViewer/groupdocs-php/api/models/GetDocumentInfoResponse.php');
//		include_once('treeViewer/groupdocs-php/api/models/GetDocumentInfoResult.php');
//		include_once('treeViewer/groupdocs-php/api/models/DocumentViewInfo.php');
//		include_once('treeViewer/groupdocs-php/api/models/DocumentInfo.php');
//		include_once('treeViewer/groupdocs-php/api/models/UploadResponse.php');
//		include_once('treeViewer/groupdocs-php/api/models/UploadRequestResult.php');
//        include_once('treeViewer/groupdocs-php/api/GroupDocsRequestSigner.php');
...
//		}
		...
		if (isset($_POST['file_id']) && $_POST['file_id'] && $clientID){
...
//                    $fs = FileStream::fromFile("$uploads_dir/$sugar_file_id.$file_ext");
//					$result = $api->Upload($clientID, $name, 'uploaded', $fs);
//					// and renameing back
...
//		}
        ...
        $cmsName = "SugarCRM";
        $cmsVersion = "1.0";
		$this->bean->iframe = '<iframe id="groupdocs_iframe" height="500" frameborder="0" width="100%" src="https://apps.groupdocs.com/document-comparison/embed/'.$this->bean->client_id.'/'.$this->bean->file_id.'?&referer=' . $cmsName . '/' . $cmsVersion . '"></iframe>';
