...
require_once('modules/GroupDocs_Comparison/gdocsc_GroupDocs_Comparison.php');
...
class gdocsc_GroupDocs_ComparisonDashlet extends DashletGeneric { 
    function gdocsc_GroupDocs_ComparisonDashlet($id, $def = null) {
		...
		require('modules/GroupDocs_Comparison/metadata/dashletviewdefs.php');

        parent::DashletGeneric($id, $def);

        if(empty($def['title'])) $this->title = translate('LBL_HOMEPAGE_TITLE', 'gdocsc_GroupDocs_Comparison');
