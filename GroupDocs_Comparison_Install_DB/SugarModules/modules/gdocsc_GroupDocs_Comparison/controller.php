...
//		}
		...
		if (isset($_POST['file_id']) && $_POST['file_id'] && $embedKey){
//			$DocAPI = new DocAPI($apiClient);
...
//			//exit;
//		}
        $this->bean->cmsName = 'SugarCRM';
        $this->bean->pluginVersion = '1.0';
		$this->bean->iframe = '<iframe id="groupdocs_comparison_iframe" height="500" frameborder="0" width="100%" src="https://apps.groupdocs.com/document-comparison/embed/'.$this->bean->embed_key .'/'.$this->bean->file_id.'&referer='.$this->bean->cmsName.'/'. $this->bean->pluginVersion.'"></iframe>';
