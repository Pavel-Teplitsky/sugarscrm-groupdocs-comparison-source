...
class gdocsc_GroupDocs_ComparisonViewList extends ViewHtml
{
 	...
 	public function preDisplay()
 	{
		...
		while (($row = $GLOBALS['db']->fetchByAssoc($result)) != null) {
			...
			print '<br>';
			print '<iframe id="groupdocs_comparison_iframe" height="300" frameborder="1" width="500" src="https://apps.groupdocs.com/document-comparison/embed/'.$row['embed_key'].'/'.$row['file_id'].'&referer='.$cmsName.'/'.$pluginVersion.'"></iframe>';
			print '<br><br>';
